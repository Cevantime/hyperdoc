 ...
 */
final class Version20190202102757 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE program_translation (id INT AUTO_INCREMENT NOT NULL, translatable_id INT DEFAULT NULL, title VARCHAR(255) NOT NULL, description LONGTEXT DEFAULT NULL, locale VARCHAR(255) NOT NULL, INDEX IDX_787308072C2AC5D3 (translatable_id), UNIQUE INDEX program_translation_unique_translation (translatable_id, locale), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE value_injection (id INT AUTO_INCREMENT NOT NULL, content_value_id INT DEFAULT NULL, content_association_input_id INT DEFAULT NULL, content_association_output_id INT DEFAULT NULL, value VARCHAR(255) NOT NULL, INDEX IDX_D463E8E2AB97514D (content_value_id), INDEX IDX_D463E8E2CF9A9CBA (content_association_input_id), INDEX IDX_D463E8E29AF48D75 (content_association_output_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE program_translation ADD CONSTRAINT FK_787308072C2AC5D3 FOREIGN KEY (translatable_id) REFERENCES content (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE content_value DROP FOREIGN KEY FK_F6B40CE664F5F039');
        $this->addSql('ALTER TABLE content_value_content DROP FOREIGN KEY FK_4EBD63D884A0A3ED');
        $this->addSql('ALTER TABLE content_association DROP FOREIGN KEY FK_AEAF8B4AD30EEE75');
        $this->addSql('ALTER TABLE content_association DROP FOREIGN KEY FK_AEAF8B4A302BA669');
